...
const registerSchema = Joi.object({
  username: Joi.string() // Le nom doit être une chaîne de caractères
  ...
  password: Joi.string() // Le mot de passe doit être une chaîne de caractères
    ...
    .messages({
      ...
      "string.pattern.base":
        '"password" doit contenir au moins une minuscule, une majuscule, un chiffre et un caractère spécial',
      "any.required": '"password" est requis',
    }),

  confirmPassword: Joi.string() // Le mot de passe doit être une chaîne de caractères
  ...
  role: Joi.string() // Le rôle doit être une chaîne de caractères
