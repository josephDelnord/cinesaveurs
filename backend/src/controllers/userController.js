...
export const updateUser = async (req, res) => {
  ...
  const { name, email, password, newPassword, confirmPassword, status, role } = req.body;
...
export const suspendUser = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ message: 'Erreur serveur lors de la suspension de l\'utilisateur' });
  }
};
...
export const activateUser = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ message: 'Erreur serveur lors de l\'activation de l\'utilisateur' });
  }
};
